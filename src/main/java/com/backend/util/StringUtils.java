...
public class StringUtils {
    ...
    private static String convertToRaw_2(String value) {
        try {
    ...
    /**
     * @param str Vietnamese
     * @return Raw string without accents
     */
    public static String convertToRaw(String str) {
        StringBuilder sb = new StringBuilder(str);
        for (int i = 0; i < sb.length(); i++) {
            sb.setCharAt(i, removeAccent(sb.charAt(i)));
        }

        return convertToRaw_2(sb.toString());
    }
}
